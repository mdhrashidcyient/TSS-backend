...
public class CurrentWeekOpenOrder {
	...
	public void setCurrentStatisticsDate(String currentStatisticsDate) {
	...
	public void setStatus(String status) {
	 ...
	 public String getPrevWeekSupplierComments() {
		return prevWeekSupplierComments;
	}
	public void setPrevWeekSupplierComments(String prevWeekSupplierComments) {
		this.prevWeekSupplierComments = prevWeekSupplierComments;
	}
	public String getCurrentWeekSupplierComments() {
		return currentWeekSupplierComments;
	}
	public void setCurrentWeekSupplierComments(String currentWeekSupplierComments) {
		this.currentWeekSupplierComments = currentWeekSupplierComments;
	}
